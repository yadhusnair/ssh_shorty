_ssh_shorty_complete() {
    ...
    local subcommands="--list --add --set --rename --remove --tag --untag --sync --ping --poll --edit --paths --help --update --fav --status --watch --run --run-script --sysinfo --tail --tunnel --close --register --export-ssh-config --keydeploy --last --import -u --upload -d --download --view -m"
